        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" id="addForm" method="post" action="${PATH}/admin/doAdd">
                        ...
                        <button type="button" id="addAdmin" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> 新增</button>
